...
- [**phind**](https://github.com/acammarat/pindol/tree/main/phind) Calculate the first order anharmonic interaction strength &Phi; to be used for the [PINDOL](https://github.com/acammarat/pindol/tree/main/pindol) code
